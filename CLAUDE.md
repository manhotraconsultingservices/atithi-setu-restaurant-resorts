...
* **Smoke suite after every change** — `node test-scripts/run_technical_tests.mjs`; the only acceptable FAIL is the pre-existing `TC-EXPENSE-SHARED` (baseline as of 2026-09-08: 278 pass / 18 skip / 1 fail). Add a test case for every fix.
